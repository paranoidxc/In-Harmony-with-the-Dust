...
func DemoCurdDeletesHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.DemoCurdDeletesReq
		...
		l := demo_curd.NewDemoCurdDeletesLogic(r.Context(), svcCtx)
		err := l.DemoCurdDeletes(&req)
		if err != nil {
			response.Response(w, nil, err)
			return
		}
