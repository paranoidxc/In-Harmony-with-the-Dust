...
class App
{
    ...
    {
        put_log(['tips' => "[webman] ----- webman_onMessage"]);
        ...
        try {
            ...
            if (
                !$controllerAndAction || Route::isDefaultRouteDisabled($plugin, $controllerAndAction['app'] ?: '*') ||
            ...
            put_log(["tips" => "app.onMessage", "key" =>  $key]);
            //var_dump(" -------------- static::callbacks before:", static::$callbacks);
            static::collectCallbacks($key, [$callback, $plugin, $app, $controller, $action, null]);
            //var_dump(" -------------- static::callbacks after:", static::$callbacks);
    ...
    {
        put_log(["tips" => " -----------webman:onWorkerStart -------"]);
    ...
    {
        put_log(["tips" =>  " ----  return an callback obj ----;"]);
