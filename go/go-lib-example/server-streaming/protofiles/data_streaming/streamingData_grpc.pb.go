...
const (
	StreamingService_GetDataStreaming_FullMethodName = "/protofiles.StreamingService/GetDataStreaming"
)
...
func (c *streamingServiceClient) GetDataStreaming(ctx context.Context, in *DataRequest, opts ...grpc.CallOption) (StreamingService_GetDataStreamingClient, error) {
	stream, err := c.cc.NewStream(ctx, &StreamingService_ServiceDesc.Streams[0], StreamingService_GetDataStreaming_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
