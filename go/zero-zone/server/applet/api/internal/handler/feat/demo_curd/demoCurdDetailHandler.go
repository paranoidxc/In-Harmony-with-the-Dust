...
func DemoCurdDetailHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.DemoCurdDetailReq
		...
		l := demo_curd.NewDemoCurdDetailLogic(r.Context(), svcCtx)
		resp, err := l.DemoCurdDetail(&req)
		if err != nil {
			response.Response(w, nil, err)
			return
		}
