...
func SysRegionDeleteHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SysRegionDeleteReq
		...
		l := sys_region.NewSysRegionDeleteLogic(r.Context(), svcCtx)
		err := l.SysRegionDelete(&req)
		if err != nil {
			response.Response(w, nil, err)
			return
		}
