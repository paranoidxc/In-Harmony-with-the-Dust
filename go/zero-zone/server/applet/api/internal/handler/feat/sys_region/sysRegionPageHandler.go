...
func SysRegionPageHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SysRegionPageReq
		...
		l := sys_region.NewSysRegionPageLogic(r.Context(), svcCtx)
		resp, err := l.SysRegionPage(&req)
		if err != nil {
			response.Response(w, nil, err)
			return
		}
