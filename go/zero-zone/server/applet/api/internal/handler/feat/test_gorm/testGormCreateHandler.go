...
func TestGormCreateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.TestGormCreateReq
		...
		l := test_gorm.NewTestGormCreateLogic(r.Context(), svcCtx)
		err := l.TestGormCreate(&req)
		if err != nil {
			response.Response(w, nil, err)
			return
		}
