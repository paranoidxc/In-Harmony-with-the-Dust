...
func SysRegionDetailHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SysRegionDetailReq
		...
		l := sys_region.NewSysRegionDetailLogic(r.Context(), svcCtx)
		resp, err := l.SysRegionDetail(&req)
		if err != nil {
			response.Response(w, nil, err)
			return
		}
