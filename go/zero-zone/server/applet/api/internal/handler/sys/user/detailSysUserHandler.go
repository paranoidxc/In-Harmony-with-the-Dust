...
func DetailSysUserHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.DetailSysUserReq
		...
		l := user.NewDetailSysUserLogic(r.Context(), svcCtx)
		resp, err := l.DetailSysUser(&req)
		if err != nil {
