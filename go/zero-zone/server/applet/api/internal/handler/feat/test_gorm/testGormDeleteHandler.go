...
func TestGormDeleteHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.TestGormDeleteReq
		...
		l := test_gorm.NewTestGormDeleteLogic(r.Context(), svcCtx)
		err := l.TestGormDelete(&req)
		if err != nil {
			response.Response(w, nil, err)
			return
		}
