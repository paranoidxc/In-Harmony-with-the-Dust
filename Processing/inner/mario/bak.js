let bg2, coin, pipe, ground, ground2;
let bg, flyright, flyleft, fastleft, fastleft2;
let fastleft3, fastright, fastright2, fastright3;
let rightup, leftup, leftjump, rightjump, leftfall, rightfall;
let duckleft, duckright, marioleft, mariowalkleft;
let mariowalkleft2, marioright, mariowalkright, mariowalkright2;
let LtoR, RtoL;
let PointsCounter = 0,
  LR = 0,
  once = 1,
...
function setup() {
  ...
  LtoR = loadImage("assets/LtoR.png");
  RtoL = loadImage("assets/RtoL.png");
  duckleft = loadImage("assets/duckleft.png");
  duckright = loadImage("assets/duckright.png");
  leftjump = loadImage("assets/leftjump.png");
  rightjump = loadImage("assets/rightjump.png");
  leftfall = loadImage("assets/leftfall.png");
  rightfall = loadImage("assets/rightfall.png");
  rightup = loadImage("assets/rightup.png");
  leftup = loadImage("assets/leftup.png");
  fastleft = loadImage("assets/fastleft.png");
  fastleft2 = loadImage("assets/fastleft2.png");
  fastleft3 = loadImage("assets/fastleft3.png");
  fastright = loadImage("assets/fastright.png");
  fastright2 = loadImage("assets/fastright2.png");
  fastright3 = loadImage("assets/fastright3.png");
  flyright = loadImage("assets/flyright.png");
  flyleft = loadImage("assets/flyleft.png");
...
function keyPressed() {
  ...
  //if (key == CODED) {
  if (keyCode == UP_ARROW) keyuplook = true;
  if (keyCode == DOWN_ARROW) keydown = true;
...
function keyReleased() {
  ...
  //if (key == CODED) {
  if (keyCode == UP_ARROW) keyuplook = false;
  if (keyCode == DOWN_ARROW) keydown = false;
