...
func TestGormDetailHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.TestGormDetailReq
		...
		l := test_gorm.NewTestGormDetailLogic(r.Context(), svcCtx)
		resp, err := l.TestGormDetail(&req)
		if err != nil {
			response.Response(w, nil, err)
			return
		}
