...
func SysRegionDeletesHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SysRegionDeletesReq
		...
		l := sys_region.NewSysRegionDeletesLogic(r.Context(), svcCtx)
		err := l.SysRegionDeletes(&req)
		if err != nil {
			response.Response(w, nil, err)
			return
		}
