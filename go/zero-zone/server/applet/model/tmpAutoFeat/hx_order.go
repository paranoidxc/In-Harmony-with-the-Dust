...
type TmpHxOrder struct {
	Id              int64   `json:"id" gorm:"column:id;comment:唯一id;"`
	No              string  `json:"no" label:"核销系统订单号" gorm:"column:no;comment:核销系统订单号;"`
	...
	IsUnverify      int     `json:"isUnverify" label:"取消核销" gorm:"column:is_unverify;comment:取消核销;"`
