...
func LoginBindHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.WechatLoginBindReq
		...
		l := wechat.NewLoginBindLogic(r.Context(), svcCtx)
		resp, err := l.LoginBind(&req)
		if err != nil {
			response.Response(w, nil, err)
			return
		}
