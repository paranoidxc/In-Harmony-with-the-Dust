...
func DemoCurdPageHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.DemoCurdPageReq
		...
		l := demo_curd.NewDemoCurdPageLogic(r.Context(), svcCtx)
		resp, err := l.DemoCurdPage(&req)
		if err != nil {
			response.Response(w, nil, err)
			return
		}
